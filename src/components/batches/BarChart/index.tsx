...
const BarGraph: React.FC<PropsI> = (props: PropsI) => {
  const data = [
    ...
    },
    {
      ...
      color:
        props.index === 2 ? 'rgba(185,185,186,1)' : 'rgba(185,185,186,0.5)',
    },
    {
      name: 'Planned Batches',
      population: props.data[3],
      color:
        props.index === 3 ? 'rgba(115, 165, 194,1)' : 'rgba(115, 165, 194,0.5)',
    },
    {
      name: 'Active Curriculums',
      population: props.data[4],
      color:
        props.index === 4 ? 'rgba(253, 181, 21,1)' : 'rgba(253, 181, 21,0.5)',
    },
  ];
