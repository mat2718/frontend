...
//     if (wants[x].client == props.currClient.clientName) {
...
//       <View>
//         <FlatList
//           data={wants.filter((wants) =>
//             wants.client.includes(props.currClient.clientName)
//           )}
//           renderItem={({ item }) => (
//             <View style={styles.listItem}>
//               <Text>
//                 {item.curriculum} {item.needBy} {item.howMany}
//               </Text>
  ...
  if (clientArray.length !== 0) {
    return (
      <View>
        <FlatList
          data={wants.filter((wants) =>
            wants.client.includes(props.currClient)
          )}
          renderItem={({ item }) => (
